...
#MODIFICAMOS LOS DOCKERFILE PARA V3
...
for line in fhin :
    if "ENV SERVICE_VERSION = v1" in line :
        fhout.write("ENV SERVICE_VERSION = v3\n")
    elif "ENV SERVICE_VERSION = v2" in line :
        fhout.write("ENV SERVICE_VERSION = v3\n")
    else :
        fhout.write(line)
...
#Creamos la imagen
os.system("sudo docker build -t 'g20/detailsv3' .")
...
#Creamos la imagen
os.system("sudo docker build -t 'g20/ratingsv3' .") 

# MODIFICAMOS EL DOCKER-COMPOSE PARA V3
...
fhin.write("\n")
fhin.write("  details:\n")
fhin.write("    container_name: g20-detailsv3\n")
fhin.write("    image: g20/detailsv3\n")
fhin.write("    expose:\n")
fhin.write("      - 9080\n")
fhin.write("\n")
fhin.write("  reviews:\n")
...
fhin.write("      - STAR_COLOR=red\n")
fhin.write("    links:\n")
fhin.write('      - "ratings"\n')
fhin.write("\n")
fhin.write("  ratings:\n")
fhin.write("    container_name: g20-ratingsv3\n")
fhin.write("    image: g20/ratingsv3\n")
fhin.write("    expose:\n")
fhin.write("      - 9080\n")
fhin.close()
